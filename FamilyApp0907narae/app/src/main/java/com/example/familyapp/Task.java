...
public class Task extends AsyncTask<String, String, String> {
    ...
    String serverUrl = "http://"+ip+":8090/FamilyApp2/"; // 연결할 jsp주소
    ...
    protected String doInBackground(String... strings) {
        try {
            ...
            }else if(sendMsg.equals("fModify.do")){
                serverUrl += sendMsg;
                sendMsg = "id=" + strings[0] + "&fName=" + strings[1] + "&motoo=" + strings[2] +
                        "&location=" + strings[3];
            }else if(sendMsg.equals("mainLogin_load.do")){
                serverUrl += sendMsg;
                sendMsg = "id="+strings[0];
